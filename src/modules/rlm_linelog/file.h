...
unlang_action_t file_batching_mod_resume(UNUSED unlang_result_t *p_result, UNUSED module_ctx_t const *mctx, UNUSED request_t *request);

xlat_action_t file_batching_xlat_resume(UNUSED TALLOC_CTX *ctx, UNUSED fr_dcursor_t *out, xlat_ctx_t const *xctx, request_t *request, UNUSED fr_value_box_list_t *in);
...
void file_thread_detach(rlm_linelog_thread_t *thread);
