...
{ .out = &attr_acc_serv_totals_requests, .name = ".radiusAccServTotalsRequests", .type = FR_TYPE_UINT32, .dict = &dict_radius },
...
{ .out = &attr_acc_serv_total_malformed_requests, .name = ".radiusAccServTotalMalformedRequests", .type = FR_TYPE_UINT32, .dict = &dict_radius },
