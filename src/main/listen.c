...
#ifdef SO_RCVTIMEO
	{ "read_timeout", FR_CONF_OFFSET(PW_TYPE_INTEGER, listen_socket_t, limit.read_timeout), },
#endif
#ifdef SO_SNDTIMEO
	{ "write_timeout", FR_CONF_OFFSET(PW_TYPE_INTEGER, listen_socket_t, limit.write_timeout), },
#endif
#endif
	CONF_PARSER_TERMINATOR
};
