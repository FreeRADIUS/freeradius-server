	 ...
	 */
	 {
		...
		if (fr_event_fd_insert(NULL, events, self_pipe[0], rs_signal_action, NULL, NULL, events) < 0) {
		...
		for (in_p = in;
			...
			if (fr_event_fd_insert(NULL, events, in_p->fd, rs_got_packet, NULL, NULL, event) < 0) {
