...
src/include/$(1): $(2)
	...
	${Q}grep ^ATTRIBUTE $$< | grep -E -v '[ 	]\.' | ${NORMALIZE}  | awk '{print "#define FR_"$$$$2 " " $$$$3 "	//!< AUTOGENERATED ATTRIBUTE DEFINITION"}' >> $$@
...
src/include/protocol/base.h: $(wildcard share/dictionary/*/dictionary) $(wildcard share/dictionary/eap/*/dictionary) | src/include/protocol
	...
	${Q}echo "#pragma once" > $@
	${Q}for X in $^; do grep -w PROTOCOL $$X | grep -E -v 'END' | sed 's/BEGIN //' | ${NORMALIZE} | awk '{print "#define FR_PROTOCOL_"$$2" " $$3 "	//!< AUTOGENERATED PROTOCOL NUMBER DEFINITION"}' >> $@; done
