 ...
 * The following code demonstrates using this function with a connection timeout:
 ...
 @endcode
 *
 * @param async If true O_NONBLOCK will be set on the fd before calling connect.
 ...
 * The following code demonstrates using this function with a connection timeout:
 ...
 @endcode
 *
 * @param src_ipaddr to bind socket to, may be NULL if socket is not bound to any specific address.
