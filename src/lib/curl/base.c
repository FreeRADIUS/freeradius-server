...
static CONF_PARSER reusable_curl_conn_config[] = {
...
CONF_PARSER fr_curl_conn_config[] = {
	{ FR_CONF_OFFSET("reusable", FR_TYPE_SUBSECTION, fr_curl_conn_config_t, reusable), .subcs = (void const *) reusable_curl_conn_config },
