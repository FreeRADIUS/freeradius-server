...
#  all unique.
#
SUBMAKEFILES := $(strip $(call uniq,$(patsubst %,${top_srcdir}/src/lib/%/all.mk,$(TALLOC_EXTENSION_DIR) util tls eap eap_aka_sim server unlang io) $(sort $(wildcard ${top_srcdir}/src/lib/*/all.mk))))
