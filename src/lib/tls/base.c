...
fr_dict_attr_t const *attr_tls_certificate_ocsp_uri;
...
fr_dict_attr_autoload_t tls_dict_attr[] = {
	...
	{ .out = &attr_tls_certificate_ocsp_uri, .name = "TLS-Certificate.OCSP-URI", .type = FR_TYPE_STRING, .dict = &dict_freeradius },
