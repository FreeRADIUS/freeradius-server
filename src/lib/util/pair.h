...
fr_pair_t	*fr_pair_find_by_da_nested(fr_pair_list_t const *list, fr_dict_attr_t const *da) CC_HINT(nonnull);

fr_pair_t	*fr_pair_find_last_by_da(fr_pair_list_t const *list, fr_dict_attr_t const *da) CC_HINT(nonnull);
