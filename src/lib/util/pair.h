...
void		fr_pair_verify_parent_da(char const *file, int line, fr_dict_attr_t const *parent, fr_pair_t const *vp) CC_HINT(nonnull(4));
...
#  define PAIR_VERIFY_PARENT_DA(_p, _x)  fr_pair_verify_parent_da(__FILE__, __LINE__, _p, _x)
...
#  define PAIR_VERIFY_PARENT_DA(_p, _x) fr_pair_list_nonnull_assert(_p); \
					  fr_pair_list_nonnull_assert(_x)
