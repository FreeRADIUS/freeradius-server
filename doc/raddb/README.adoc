...
* `mods-available/` - <<mods-available/README.md#,Available modules>>, with example configuration.
* `mods-enabled/` - Enabled modules that are being used by FreeRADIUS.
* `sites-available/` - <<sites-available/README.md#,Available virtual servers>>, with example configuration.
