...
<value>::  The value which is assigned to the attribute.  If the field is a double-quoted string, it undergoes link:xlat.adoc[string expansion], and the resulting value is assigned to the attribute.
