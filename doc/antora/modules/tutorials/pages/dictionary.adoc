...
dictionary entries, they must go into xref:raddb/dictionary.adoc[local
dictionary] file or into `dictionary.d/`.
...
virtual server without adding anything to the xref:raddb/dictionary.adoc[local dictionary] file or
`dictionary.d/`.
