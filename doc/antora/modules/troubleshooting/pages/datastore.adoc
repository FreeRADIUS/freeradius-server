...
* The := operator should not be used in the users file to set the Auth-Type since it will set the Auth-Type regardless of whether it has already being set to some other value.
...
Once you are satisfied that the results represent only those IP addresses not
