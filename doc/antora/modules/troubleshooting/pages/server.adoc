...
Run the server in xref:ROOT:debugging/radiusd_X.adoc[debugging] mode:
...
|To temporarily disable or down the server
|svc -d /service/radiusd

|To re-enable or bring the service back online
