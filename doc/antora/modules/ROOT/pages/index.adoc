...
Administrators using v3 that wish to upgrade to v4
...
release. Do *not* use v3 configuration files with v4. These configuration files are *not* compatible on this major version upgrade.
...
The https://www.inkbridge.io/[RADIUS experts] are available to help you with your FreeRADIUS customizations. See xref:gethelp.adoc[Getting Help] for more information and additional resources.
