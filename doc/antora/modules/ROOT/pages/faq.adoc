...
FreeRADIUS is an open-source product with all the benefits of open-source software that includes flexibility, scalability, and cost-effectiveness. FreeRADIUS has many features not found in other free and commercial versions. Some of these features are:
...
[%collapsible]
====
Many NAS support SNMP which can usually (among other things) be used to disconnect users, however implementation details vary. Read your NAS documentation to find out whether it supports this, and which MIB to use.
====
