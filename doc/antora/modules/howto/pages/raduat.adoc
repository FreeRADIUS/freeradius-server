...
The values use the same format as the normal `unlang` attribute assignments, or the xref:raddb/mods-config/files/users.adoc[users file].  A short summary is given here for convenience.
