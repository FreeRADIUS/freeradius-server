...
Alvarion gateways implement a non-standard version of WiMAX.  If you with to use Alvarion, you *must* use the "master" branch from http://git.freeradius.org.  Then, before you install it, do:
