...
process. This will supersede the need to enable the sending of _Alive_
packets as described below for IOS versions 11.x
...
`update newinfo` it will send an account `Alive` packet which
