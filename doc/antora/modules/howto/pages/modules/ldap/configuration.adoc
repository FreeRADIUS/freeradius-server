...
ldap {
	...
	base_dn = '<dn_that_parents_user_obj_and_group_obj>'  <4>
	...
	user {
		...
		filter = '(&(<uid_attribute>=%{%{Stripped-User-Name}:-%{User-Name}})(<user_object_class_filter>))'  <6>
	}
}
----
...
See xref:modules/ldap/authorization.adoc[LDAP authorization] for more detailed
