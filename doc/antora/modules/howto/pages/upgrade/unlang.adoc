...
The configuration language (Unlang) is now more concise and robust. You now edit attributes with specific statements in processing sections. The old-style `update` sections are deprecated.
