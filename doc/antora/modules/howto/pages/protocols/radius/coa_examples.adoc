...
Upon receiving a CoA or Disconnect packet the server identifies all active
sessions matching the provided User-Name and/or Acct-Session-Id attributes. The server sends a subrequest packet for every identified session to the corresponding NAS.
