...
== Authorize your local machine to talk to GitHub
...
This can be done, but we don't recommend it.
...
@todo - windows instructions - Currently your only option is to cry
yourself to sleep knowing you'll never be able to contribute to
FreeRADIUS (or figure it out on your own).
