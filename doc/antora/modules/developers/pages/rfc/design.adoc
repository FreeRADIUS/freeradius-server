...
explicitly allowed or forbid behaviour.  Developers should not assume
something is allowed just because it is not prohibited.  Any new
behaviour that you invent is likely to conflict with After 20 years of
...
Additional problems with the RADIUS standards and implementations are
listed on the
...
https://www.inkbridgenetworks.com/blog/blog-10/the-freeradius-auth-type-attribute-103[The
FreeRADIUS Auth-Type attribute]

https://www.inkbridgenetworks.com/blog/blog-10/radius-standards-compliance-from-rfc-to-wifi-alliance-135[RADIUS
standards compliance: from RFC to WiFi Alliance]
