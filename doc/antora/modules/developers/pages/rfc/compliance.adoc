...
* De Facto Standard: RADIUS is the industry standard for centralising
...
* Consistent behaviour: RFCs provide documented, predictable
  behaviour, reducing unexpected issues when integrating new equipment
