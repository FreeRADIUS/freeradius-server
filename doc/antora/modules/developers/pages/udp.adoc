...
software in the kernel, is called Receive Packet Steering (RPS).  This
...
Cloudfare has some notes:
https://blog.cloudflare.com/how-to-achieve-low-latency/

Turn server has some notes:
...
On systems without RSS, we can get TCP-like behaviour with some hacks.
...
handler has to take care of manually sending them over to the new
connection.
