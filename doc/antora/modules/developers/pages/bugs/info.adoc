...
Submit the information from the log file, along with any
log output files, the output of `radiusd -xv`, and the required information about your environment to the GitHub FreeRADIUS https://github.com/FreeRADIUS/freeradius-server/issues[Issues] page.

Submit all the *required* logs and relevant information with your xref:bugs/bugs.adoc#CreateIssue[Issue Defect Report].
