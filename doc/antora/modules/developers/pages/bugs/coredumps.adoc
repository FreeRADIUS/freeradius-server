...
and follow the instructions in the xref:bugs/info.adoc[Extract
Information]] section.

You can also enable the `panic_action` given in `radiusd.conf`. See
the comments in that file for more details about automatically
