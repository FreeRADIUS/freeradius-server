...
https://datatracker.ietf.org/doc/rfc2865[RFC 2865] and
https://datatracker.ietf.org/doc/rfc2866[RFC 2866]. These are
the new RFCs, which replace the old ones,
https://datatracker.ietf.org/doc/rfc2138[RFC 2138] and
https://datatracker.ietf.org/doc/rfc2139[RFC 2139].
