...
== xref:contributing.adoc[Contributions]
...
FreeRADIUS provides APIs to handle xref:dbuff.adoc[Data buffers]
xref:sbuff.adoc[String buffers] enabling devlopers streamline their coding and processes.
