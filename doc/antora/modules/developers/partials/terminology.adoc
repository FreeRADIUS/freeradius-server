...
| thus, thusly                          | therefore, as a result, so, thereby| Thus is a formal term and not recommended for software docs. Try rephrasing the sentence to remove the word.
...
| clients                               | network clients, NAS           | Refers to any device that communicates directly with the RADIUS server.
