...
|https://datatracker.ietf.org/doc/html/rfc2866#section-5.5[Acct-Session-Id] | An ID assigned to a session and tracked by this ID via log files. Example stop and start events are mapped to this ID.
