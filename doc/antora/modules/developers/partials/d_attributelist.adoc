...
|https://datatracker.ietf.org/doc/html/rfc5090#section-3.8[Digest-Qop]  |Contains the `Quality of Protection` parameter that impacts the HTTP Digest calculation.
