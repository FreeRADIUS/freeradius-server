...
RADIUS is a protocol for remote user Authorization, Authentication, and Accounting. It's very important for Internet Service Providers, and any network that needs a centralised authentication and/or accounting services for its infrastructure.
