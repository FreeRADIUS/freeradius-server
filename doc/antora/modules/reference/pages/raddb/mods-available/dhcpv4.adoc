...
will be dropped. This module does not (yet) support receiving replies
from the DHCPv4 server. Any packets sent to the outgoing socket will
be discarded.
...
The default DHCPv4 client port is 68. It should be changed from this
only for testing.
