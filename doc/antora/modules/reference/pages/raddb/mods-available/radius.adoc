...
attribute.  This behaviour is *NOT* configurable, and *CANNOT* be
changed.  This behaviour is part of the BlastRADIUS mitigations.
...
mode:: What kind of client behaviour is being used.
...
This behaviour mitigates against the BlastRADIUS attack.
