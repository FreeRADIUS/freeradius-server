...
Information for the connection pool. The configuration items below are
the same for all modules which use the new connection pool.
...
NOTE: Idle connections WILL be closed if `idle_timeout` is set. This
