...
AN INTERACTIVE ACTION MEANS THE SERVER WILL NOT RESTART.
...
the debug output is usually also able to view and/or modify
...
#	* delete any pre-existing debug log for this user
