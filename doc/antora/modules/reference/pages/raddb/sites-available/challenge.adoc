...
Do authentication for step 2. Set the "known good" password to the
number saved in the session-state list.
...
Send an Access-Challenge. See policy.d/control for the definition of
"challenge"
