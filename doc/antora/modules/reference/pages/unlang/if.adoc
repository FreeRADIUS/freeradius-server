...
An `if` statement can optionally be followed by an xref:unlang/else.adoc[else] or an xref:unlang/elsif.adoc[elsif] statement.
...
The same behaviour applies to conditions with complex statements using
