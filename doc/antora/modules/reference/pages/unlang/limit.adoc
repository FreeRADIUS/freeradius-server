...
In the following example, the configuration limits the concurrent proxy requests to a maximum of `4`. If the limit is hit, catch the fail and write to a detail file instead.
