...
Instead, you can add site-specific dictionary definitions in the
xref:raddb/dictionary.adoc[local dictionary] file.
...
xref:dictionary/alias.adoc[ALIAS] keyword can help.  See the
xref:raddb/dictionary.adoc[local dictionary] for additional
documentation.
...
Site-specific edits should be kept to the
xref:raddb/dictionary.adoc[local dictionary] file, which will not be
