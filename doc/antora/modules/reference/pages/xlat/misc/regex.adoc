...
xref:unlang/condition/regex.adoc[`=~`] operator) clears and refreshes the list of
...
described xref:xlat/misc/regex.adoc#regex_0_32[above].
...
.Using a numbered subpattern after a search
====
[source,unlang]
----
...
.Using a named subpattern after a search
====
[source,unlang]
----
