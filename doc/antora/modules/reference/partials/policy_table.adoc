...
| xref:raddb/mods-available/interval.adoc[interval]	| Rate-limits requests over a time interval, returning 'true' when a request is allowed or 'false' when the interval limit has been exceeded.
