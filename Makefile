...
test: ${BUILD_DIR}/bin/radiusd ${BUILD_DIR}/bin/radclient tests.eap tests.unit tests.xlat tests.keywords tests.auth tests.modules $(BUILD_DIR)/tests/radiusd-c | build.raddb
