...
# ===========================================================================
# USER CONFIG: whole-program cost categories
...
#   observed FreeRADIUS profiles; adjust accordingly.
# ===========================================================================
CATEGORIES=(
...
if [ -n "$MD_FILE" ]; then
  ...
  {
    echo "# CEst Profiling Assessment"
    echo
    echo "_Generated by analyze_profiling_results_cest.sh. Tables are computed"
    echo "from callgrind.out.* files; prose marked TODO is for manual analysis._"
    echo
    ...
    echo "## Conclusions"
    echo
    echo "<!-- TODO: manual analysis. Numbers are above; interpret them:"
    echo "  1. total-cost delta and whether the workload was matched"
    echo "  2. whether the pattern's self-cost moved with total cost"
    echo "  3. which categories drive the difference"
    echo "  4. largest optimization levers regardless of pattern -->"
    echo
    echo "## Methodology"
    echo
