...
Run the `install_deps.sh` script to install the build dependencies. It's recommended to create a copy of this file and edit locally. You can remove apps, libs, or utilities that you don't need such as postgresql. Ensure that you use the updated file when running the script.
...
```
Note: if using a different shell, ensure you copy the environment parameters to your current shell.

### Getting the Source

Open a new shell and navigate to the directory where you want to install the FreeRADIUS server.

Download the latest version from a git repository:
